...
//Post is POST
func (hdl *TotalHandler) Post(w http.ResponseWriter, r *http.Request) {
}

//Delete is DELETE
func (hdl *TotalHandler) Delete(w http.ResponseWriter, r *http.Request) {
}

//Get is GET
func (hdl *TotalHandler) Get(w http.ResponseWriter, r *http.Request) {
...
func (hdl *TotalHandler) dauByDate(ctx context.Context, game string, gameTbl *mongo.Collection, start, end int64) (dau int, err error) {
