...
func (x *DauReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DauReq) ProtoMessage() {}

func (x *DauReq) ProtoReflect() protoreflect.Message {
	mi := &file_proxy_proto_msgTypes[0]
...
// Deprecated: Use DauReq.ProtoReflect.Descriptor instead.
func (*DauReq) Descriptor() ([]byte, []int) {
	return file_proxy_proto_rawDescGZIP(), []int{0}
}

func (x *DauReq) GetChain() Chain {
	if x != nil {
		return x.Chain
	}
...
func (x *DauReq) GetContracts() []string {
	if x != nil {
		return x.Contracts
	}
	return nil
...
func (x *TxCountReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TxCountReq) ProtoMessage() {}

func (x *TxCountReq) ProtoReflect() protoreflect.Message {
	mi := &file_proxy_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TxCountReq.ProtoReflect.Descriptor instead.
func (*TxCountReq) Descriptor() ([]byte, []int) {
	return file_proxy_proto_rawDescGZIP(), []int{2}
}

func (x *TxCountReq) GetChain() Chain {
	if x != nil {
		return x.Chain
	}
	return Chain_UNKNOWN
...
func (x *TxCountReq) GetStart() int64 {
	if x != nil {
		return x.Start
	}
	return 0
...
func (x *TxCountReq) GetEnd() int64 {
	if x != nil {
		return x.End
	}
	return 0
...
func (x *TxCountReq) GetContracts() []string {
	if x != nil {
		return x.Contracts
	}
	return nil
...
var file_proxy_proto_rawDesc = []byte{
	,
...
var file_proxy_proto_goTypes = []interface{}{
	...
	(*DauReq)(nil),     // 1: DauReq
	(*DauRsp)(nil),     // 2: DauRsp
	(*TxCountReq)(nil), // 3: TxCountReq
	(*TxCountRsp)(nil), // 4: TxCountRsp
}
var file_proxy_proto_depIdxs = []int32{
	0, // 0: DauReq.chain:type_name -> Chain
	0, // 1: TxCountReq.chain:type_name -> Chain
	1, // 2: DBProxy.Dau:input_type -> DauReq
	3, // 3: DBProxy.TxCount:input_type -> TxCountReq
	2, // 4: DBProxy.Dau:output_type -> DauRsp
	4, // 5: DBProxy.TxCount:output_type -> TxCountRsp
